...
namespace Hofff\Contao\LanguageRelations\News\EventListener;
...
final class SqlCommandsListener
{
    ...
    public function __invoke(array $queries): array
    {
        ...
        foreach ($this->schema->views() as $view) {
            ...
            $queries['hofff-contao-language-relations-news'][$view->getName()] = $this->connection->getDatabasePlatform()->getCreateViewSQL(
                $view->getName(),
                $view->getSql()
            );
        }
