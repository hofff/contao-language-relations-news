...
namespace Hofff\Contao\LanguageRelations\News\Migration;

use Contao\CoreBundle\Migration\AbstractMigration;
use Contao\CoreBundle\Migration\MigrationResult;
use Doctrine\DBAL\Connection;
use Doctrine\DBAL\Exception;
use Hofff\Contao\LanguageRelations\News\Database\Schema as DatabaseSchema;
...
final class ViewsMigration extends AbstractMigration
{
    ...
    {
        if (! $this->connection->getSchemaManager()->tablesExist('tl_hofff_language_relations_news')) {
            return false;
        }

        $path = $this->fileLocator->locate('@HofffContaoLanguageRelationsNewsBundle');
